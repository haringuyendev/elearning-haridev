...
const BackToTop = () => {
  ...
  useEffect(() => {
    const progressPath = progressRef.current?.querySelector("path") as SVGPathElement | null;
  ...
  return (
    <div className="rbt-progress-parent" ref={progressRef as React.RefObject<HTMLDivElement>}>
      <svg
