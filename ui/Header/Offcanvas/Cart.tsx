...
import { setCartToggle } from "@/redux/reducer/UiSlices";
import { deleteCartItemThunk } from "@/redux/action/CartAction";
...
const Cart = () => {
  ...
  const total_amount = useSelector((state: RootState) => state.cart.total_amount);

  const { cartToggle } = useSelector((state: RootState) => state.ui);
              ...
              <div className="content">
                ...
                <div className="rbt-btn-close" id="btn_sideNavClose">
                  <button
                    ...
                    onClick={() => dispatch(setCartToggle(!cartToggle))}
                  >
                    ...
                    <li className="minicart-item" key={index}>
                      ...
                      <div className="close-btn">
                        <button
                          ...
                          onClick={() => dispatch(deleteCartItemThunk(data.id))}
                        >
                          <i className="feather-x"></i>
                        </button>
                      </div>
