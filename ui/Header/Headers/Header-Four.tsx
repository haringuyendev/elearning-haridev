...
import { CartState } from "@/redux/interface/common";

const HeaderFour = ({ gapSpaceBetween, headerSticky:sticky, navigationEnd, container }:HeaderProps) => {
  const { mobile, setMobile, search, setSearch, cartToggle, setCart } =
    useAppContext();
  const [isSticky, setIsSticky] = useState(false);
  

const { total_items } = useSelector((state: { CartReducer: CartState }) => state.CartReducer);
