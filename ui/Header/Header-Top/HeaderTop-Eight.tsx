    ...
    >
      <div className={`${container}`}>
        <div className="top-expended-wrapper">
          {HeaderTopData &&
            HeaderTopData.headerTopOne.map((item: any, index: any) => (
              <div
                  ...
                  <div className="rbt-header-content justify-content-start justify-content-lg-end">
                    ...
                    <div className="header-info">
                      <ul className="rbt-dropdown-menu switcher-language">
                        {item.language.map((lng: any, innerIndex: any) => (
                          <li className="has-child-menu" key={innerIndex}>
                            ...
                            <ul className="sub-menu">
                              {lng.subLng.map((sublng: any, innerIndex: any) => (
                                <li key={innerIndex}>
                    ...
                    <div className="header-info">
                      <ul className="rbt-dropdown-menu currency-menu">
                        {item.currency.map((curnc: any, innerIndex: any) => (
                          <li className="has-child-menu" key={innerIndex}>
                            ...
                            <ul className="sub-menu hover-reverse">
                              {curnc.subCurr.map((sub: any, subIndex: any) => (
                                <li key={subIndex}>
                                  <Link href={sub.link}>
                                    <span className="menu-item">
                                      {sub.currency}
