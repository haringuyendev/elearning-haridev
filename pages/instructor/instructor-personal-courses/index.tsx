...
import MyCourses from "@/components/instructor/MyCourse";
...
const PersonalCoursesPage = () => {
  return (
    <>
      <PageHead title="Instructor Personal Courses History Attempts Course - Online Courses & Education NEXTJS14 Template" />
          <MobileMenu />
